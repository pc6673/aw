...
HD_PWD='c:/Users/062062/Desktop/trimode_example/xc7z020clg400_example/rgmii_example/gmii_to_rgmii_0_ex/gmii_to_rgmii_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gmii_to_rgmii_0_example_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gmii_to_rgmii_0_example_design.tcl -notrace
