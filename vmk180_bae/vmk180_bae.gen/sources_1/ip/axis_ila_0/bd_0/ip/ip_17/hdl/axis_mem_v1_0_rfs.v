...
endgenerate
 ...
 begin :Cumulative_probe_width_2
   ...
   assign connect_wire[0] = we_4_ext_cdc;  
...
//Logic for handling rd_en signal during backpressure scenario 
    generate
     ...
     begin: EXT_BACKPRESSURE
       ...
       else if (WE_WRITE_I_d)
       begin
         last_wr_addr <= ADDR_WRITE_I_d;
       end
       else
       begin
       ...
       else if (we_4_ext_cdc & ~WE_WRITE_I_d & en_deep_storage_d)
       begin
         tmp     <= 1'b1;
         wr_flag <= 1'b1;
       end 
...
*/   
    ...
    .we_4_ext           (we_4_ext_cdc | wr_flag ),
    .we_4_ext_t         (we_4_ext_reg | wr_flag_f),        
    .ADDR_WRITE_I_t     (ADDR_WRITE_I_d),    
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              else if (m_axis_tready_t & (~flag |flag_2))
              begin
                ext_strg_read_en_t <= 1'b1 ;
              end
	      else
 ...
 generate 
   ...
   begin :state_for_cumulative_probe
      ...
      begin
		...
		else if(en_deep_storage_t == 1)   //going to next state only when external storage is enabled by software
		begin
		  state <= COUNT;
		...
		if ((ext_strg_addr_t  == ADDR_WRITE_I_t_comp) & (flag_addr_incr) )
		begin
		  counter <= counter + 1;
		  flag    <= 1'b1;
		end
   ...
   begin :state_for_less_than_512
      ...
      begin
		...
		if ((ext_strg_addr_t  == ADDR_WRITE_I_t_comp ) & (flag_addr_incr_d))
		begin
		  counter <= counter + 1;
		  flag    <= 1'b1;
		end
